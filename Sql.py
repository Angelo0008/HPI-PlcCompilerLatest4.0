...
def CreateDatabaseTable():
    ...
    create_cursor.execute("""
        CREATE TABLE IF NOT EXISTS database_data(
            ...
            Process_1_Em2p_Inspection_3_Median_Data VARCHAR(64),
            Process_1_Em2p_Inspection_4_Median_Data VARCHAR(64),
            Process_1_Em2p_Inspection_5_Median_Data VARCHAR(64),
            Process_1_Em3p VARCHAR(64),
            Process_1_Em3p_Lot_No VARCHAR(64),
            ...
            Process_1_Em3p_Inspection_3_Median_Data VARCHAR(64),
            Process_1_Em3p_Inspection_4_Median_Data VARCHAR(64),
            Process_1_Em3p_Inspection_5_Median_Data VARCHAR(64),
            Process_1_Harness VARCHAR(64),
            Process_1_Harness_Lot_No VARCHAR(64),
            Process_1_Frame VARCHAR(64),
            Process_1_Frame_Lot_No VARCHAR(64),
            ...
            Process_1_Frame_Inspection_1_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_2_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_3_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_4_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_5_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_6_Median_Data VARCHAR(64),
            Process_1_Frame_Inspection_7_Median_Data VARCHAR(64),
            Process_1_Bushing VARCHAR(64),
            Process_1_Bushing_Lot_No VARCHAR(64),
            Process_1_ST VARCHAR(64),
            Process_1_Actual_Time VARCHAR(64),
            ...
            Process_2_Rod_Blk_Tesla_1_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Tesla_2_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Tesla_3_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Tesla_4_Median_Data VARCHAR(64),
            ...
            Process_2_Rod_Blk_Inspection_1_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_2_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_3_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_4_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_5_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_6_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_7_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_8_Median_Data VARCHAR(64),
            Process_2_Rod_Blk_Inspection_9_Median_Data VARCHAR(64),
            Process_2_Df_Blk VARCHAR(64),
            Process_2_Df_Blk_Lot_No VARCHAR(64),
            ...
            Process_2_Df_Blk_Inspection_1_Median_Data VARCHAR(64),
            Process_2_Df_Blk_Inspection_2_Median_Data VARCHAR(64),
            Process_2_Df_Blk_Inspection_3_Median_Data VARCHAR(64),
            Process_2_Df_Blk_Inspection_4_Median_Data VARCHAR(64),
            Process_2_Df_Blk_Tensile_Rate_Of_Change_Average VARCHAR(64),
            Process_2_Df_Blk_Tensile_Rate_Of_Change_Median VARCHAR(64),
            Process_2_Df_Blk_Tensile_Start_Force_Average VARCHAR(64),
            Process_2_Df_Blk_Tensile_Start_Force_Median VARCHAR(64),
            Process_2_Df_Blk_Tensile_Terminating_Force_Average VARCHAR(64),
            Process_2_Df_Blk_Tensile_Terminating_Force_Median VARCHAR(64),
            Process_2_Df_Ring VARCHAR(64),
            Process_2_Df_Ring_Lot_No VARCHAR(64),
            Process_2_Washer VARCHAR(64),
            Process_2_Washer_Lot_No VARCHAR(64),
            ...
            Process_3_Casing_Block_Inspection_1_Median_Data VARCHAR(64),
            Process_3_Casing_Gasket VARCHAR(64),
            Process_3_Casing_Gasket_Lot_No VARCHAR(64),
            Process_3_M4x16_Screw_1 VARCHAR(64),
            Process_3_M4x16_Screw_1_Lot_No VARCHAR(64),
            ...
            Process_6_NG_Cause VARCHAR(64),
            Process_6_Repaired_Action VARCHAR(64),
            Process_1_SERIAL_NO VARCHAR(64),
            Process_2_SERIAL_NO VARCHAR(64),
            Process_3_SERIAL_NO VARCHAR(64),
            Process_4_SERIAL_NO VARCHAR(64),
            Process_5_SERIAL_NO VARCHAR(64),
            Process_6_SERIAL_NO VARCHAR(64)
        )
        """)
...
def InsertDataToFC1DatabaseTable(df):
    ...
    insert_query = """
        INSERT INTO database_data (
            ...
            Process_1_Em2p_Inspection_3_Median_Data,
            Process_1_Em2p_Inspection_4_Median_Data,
            Process_1_Em2p_Inspection_5_Median_Data,
            Process_1_Em3p,
            Process_1_Em3p_Lot_No,
            ...
            Process_1_Em3p_Inspection_3_Median_Data,
            Process_1_Em3p_Inspection_4_Median_Data,
            Process_1_Em3p_Inspection_5_Median_Data,
            Process_1_Harness,
            Process_1_Harness_Lot_No,
            Process_1_Frame,
            Process_1_Frame_Lot_No,
            ...
            Process_1_Frame_Inspection_1_Median_Data,
            Process_1_Frame_Inspection_2_Median_Data,
            Process_1_Frame_Inspection_3_Median_Data,
            Process_1_Frame_Inspection_4_Median_Data,
            Process_1_Frame_Inspection_5_Median_Data,
            Process_1_Frame_Inspection_6_Median_Data,
            Process_1_Frame_Inspection_7_Median_Data,
            Process_1_Bushing,
            Process_1_Bushing_Lot_No,
            Process_1_ST,
            Process_1_Actual_Time,
            ...
            Process_2_Rod_Blk_Tesla_1_Median_Data,
            Process_2_Rod_Blk_Tesla_2_Median_Data,
            Process_2_Rod_Blk_Tesla_3_Median_Data,
            Process_2_Rod_Blk_Tesla_4_Median_Data,
            ...
            Process_2_Rod_Blk_Inspection_1_Median_Data,
            Process_2_Rod_Blk_Inspection_2_Median_Data,
            Process_2_Rod_Blk_Inspection_3_Median_Data,
            Process_2_Rod_Blk_Inspection_4_Median_Data,
            Process_2_Rod_Blk_Inspection_5_Median_Data,
            Process_2_Rod_Blk_Inspection_6_Median_Data,
            Process_2_Rod_Blk_Inspection_7_Median_Data,
            Process_2_Rod_Blk_Inspection_8_Median_Data,
            Process_2_Rod_Blk_Inspection_9_Median_Data,
            Process_2_Df_Blk,
            Process_2_Df_Blk_Lot_No,
            ...
            Process_2_Df_Blk_Inspection_1_Median_Data,
            Process_2_Df_Blk_Inspection_2_Median_Data,
            Process_2_Df_Blk_Inspection_3_Median_Data,
            Process_2_Df_Blk_Inspection_4_Median_Data,
            Process_2_Df_Blk_Tensile_Rate_Of_Change_Average,
            Process_2_Df_Blk_Tensile_Rate_Of_Change_Median,
            Process_2_Df_Blk_Tensile_Start_Force_Average,
            Process_2_Df_Blk_Tensile_Start_Force_Median,
            Process_2_Df_Blk_Tensile_Terminating_Force_Average,
            Process_2_Df_Blk_Tensile_Terminating_Force_Median,
            Process_2_Df_Ring,
            Process_2_Df_Ring_Lot_No,
            Process_2_Washer,
            Process_2_Washer_Lot_No,
            ...
            Process_3_Casing_Block_Inspection_1_Median_Data,
            Process_3_Casing_Gasket,
            Process_3_Casing_Gasket_Lot_No,
            Process_3_M4x16_Screw_1,
            Process_3_M4x16_Screw_1_Lot_No,
