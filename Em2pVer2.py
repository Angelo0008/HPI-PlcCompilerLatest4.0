...
def ReadInspectionData(itemCode, lotNumber):
    ...
    try:
        ...
        if itemCode == "EM0580106P":
            EM2PData = Sql.SelectAllDataFromTable("em0580106p_inspection")
            print("EM0580106P")
        ...
        filteredData = EM2PData[(EM2PData["Lot_Number"].isin([str(lotNumber)]))]
...
# Sql.SqlConnection()
# ReadInspectionData("EM0580106P", "CAT-4J15DI")
